...
<head>
    ...
    <title>Tech store - Fone de Ouvido Bluetooth</title>
        ...
        <div class="product-details">
            ...
            <div class="product-info">
                <p class="product-path">
                    <i class="fas fa-chevron-right"></i> Tecnologia / Fone / Sem Fio
                </p>
                <h2>Fone de Ouvido Bluetooth - Preto</h2>
                <p class="product-code">Código do Produto: 99FBSF005</p>
            ...
            <div class="product-specs">
                ...
                <div class="specs-content">
                    <div>
                        <p><strong>SKU:</strong> AC123466A</p>
                        <p><strong>Material externo:</strong> Plastico ABS</p>
                        <p><strong>Tempo de bateria:</strong> Até 20 horas</p>
                        <p><strong>Conctividade:</strong> Bluetooth 5.0</p>
                    </div>
                </div>
            </div>
        </div>
